...
function renderJob(job){
  ...
  if(job.results.length&&job.mode!=='upgrades')html+='<p class="result-note">± is an approximate 95% confidence interval for mean DPS. “Uncertain” means the difference is within combined statistical uncertainty, not that the builds are equal. Increase precision for small differences.</p>';
