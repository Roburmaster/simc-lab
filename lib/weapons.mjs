...
export const publicSpec=s=>({key:s.key,label:s.label,class:s.class,spec:s.spec,className:s.className,specName:s.specName,season:s.season,stale:!!s.stale,ours:!!s.ours,provenance:s.provenance||null,file:s.file,tank:s.tank});
